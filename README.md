...
[`quickbit-native`](https://github.com/holepunchto/quickbit-native)
...
`quickbit-native` itself is licensed under Apache-2.0 by Holepunch; this
...
[workflow]:
  https://github.com/digidem/quickbit-native-nodejs-mobile/actions/workflows/prebuilds.yml
